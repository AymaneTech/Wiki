    ...
    <main class="container mx-auto my-8">
                    ...
                    <div class="flex flex-col p-4 w-[380px] rounded-lg shadow-lg transition-transform hover:scale-105">
                        <div class="img w-[350px] h-[450px]">
                            <a href="<?= APP_URL ?>wikis/category/<?= $item->__get("categoryId") ?>">
                                <img src="data:image/jpg;charset=utf8;base64,<?= base64_encode($item->__get("categoryImage")) ?>"
        ...
        <div class="wikis-parent flex flex-col mx-auto md:w-2/3 gap-4">
            ...
            <?php foreach ($wikis as $wiki) : ?>
                <article
                        class="custom-card p-4 flex flex-col md:flex-row bg-white shadow-lg rounded-lg w-full md:max-w-full overflow-hidden transition-transform hover:scale-105">
