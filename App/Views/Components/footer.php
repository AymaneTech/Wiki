<footer class="mt-20 p-4 bg[#e2e8f0] sm:p-6">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-600-400">
                        <li class="mb-4">
                            <a href="https://flowbite.com" class="hover:underline">youcode</a>
                        </li>
                        <li>
                            <a href="https://tailwindcss.com/" class="hover:underline">Bug Busters</a>
                        </li>
                    </ul>
                </div>
                <div>
