                        ...
                        <?php foreach ($data as $category):?>
                            <tr>
                                ...
                                <span class="text-[13px] font-medium text-gray-800">
                                    <?= $category->__get("categoryId") ?>
                                </span>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-300">
                                    <img src="<?= STORAGE_PATH . $category->__get("categoryImage")?>"
                                         alt="<?= $category->__get("categoryName") ?>"
                                         class="w-8 h-8 rounded object-cover block">
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-300">
                                    <a href="#"
                                       class="text-gray-900 text-sm font-medium hover:text-blue-500 ml-2 truncate">
                                        <?= $category->__get("categoryName") ?>
                                    </a>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-300">
                                <span class="text-[13px] font-medium text-gray-800">
                                    <?= mb_strimwidth($category->__get("categoryDescription"), 0, 70, "...") ?>
                                </span>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-300">
                                    <div class="flex items-center gap-4">
                                        <form action="<?= APP_URL ?>categories/edit" method="post">
                                            <input type="hidden" name="editId" value="<?= $category->__get("categoryId") ?>">
                                        ...
                                        <form action="<?= APP_URL ?>categories/delete" method="post">
                                            <input type="hidden" name="deleteId" value="<?= $category->__get("categoryId") ?>">
